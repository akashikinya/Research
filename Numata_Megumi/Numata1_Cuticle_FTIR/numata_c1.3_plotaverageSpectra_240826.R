...
#Select csv
print("_transposed should be selected")
...
avr_plot <- ggplot(df_reshape, aes(x = wavenumber, y = value, color = variable, linetype = variable)) +
  geom_line() +
  scale_color_manual(values = c("lightpink2", "lightpink2", "coral", "coral", "red", "red", "darkred", "darkred")) +
...
avr_plot <- ggplot(df_reshape, aes(x = wavenumber, y = value, color = variable, linetype = variable)) +
  geom_line() +
  scale_color_manual(values = c("skyblue", "skyblue", "darkblue", "darkblue")) +
...
avr_plot <- ggplot(df_reshape, aes(x = wavenumber, y = value, color = variable, linetype = variable)) +
  geom_line() +
  scale_color_manual(values = c("palegreen", "palegreen", "green", "green", "darkgreen", "darkgreen")) +
  scale_linetype_manual(values = c(1, 1, 1, 1, 1, 1)) +
  scale_x_continuous(breaks = seq(min(df_reshape$wavenumber, na.rm = TRUE), max(df_reshape$wavenumber, na.rm = TRUE), by = 200)) +
  labs(x = "wavenumber", y = "") +
  theme_minimal() +
